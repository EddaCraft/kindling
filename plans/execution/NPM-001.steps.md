...
| Task(s) | NPM-001 — Add package metadata to all package.json files |
| Created by | @aneki / AI |
| Status | Draft |
...
### 2. Update @kindling/core package.json
...
### 3. Update @kindling/store-sqlite package.json
...
### 4. Update @kindling/provider-local package.json
...
### 5. Update @kindling/adapter-opencode package.json
...
### 6. Update @kindling/adapter-pocketflow package.json
...
### 7. Update @kindling/cli package.json
